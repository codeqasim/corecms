...
$router->post('account/products/upload', function() {
    ...
    if (!empty($_FILES["file"]["name"])) {
        ...
        $sql = "INSERT INTO `products_images` (`image_id`, `image_product_id`, `image_created_at`, `image_updated_at`, `image_name`) VALUES (NULL, '".$queries['source']."', '2022-05-27 03:37:34.000000', '', '".$img."');";
