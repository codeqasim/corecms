...
$router->get('account/stores', function() {
    ...
    $xcrud->fields('store_img,store_name,store_category_id,store_city_id,store_status,store_mobile,store_address,store_mobile,store_views,store_desc,store_user_id');
